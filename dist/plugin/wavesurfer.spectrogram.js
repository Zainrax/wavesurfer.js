/*!
 * wavesurfer.js spectrogram plugin 5.2.0 (2023-08-07)
      ...
      if (spectrCc) {
        ...
        for (var i = 0; i < width; i++) {
          for (var j = 0; j < height; j++) {
            ...
            var redIndex = ((height - 1 - j) * width + i) * 4;
        ...
        createImageBitmap(imageData).then(function (renderer) {
          spectrCc.drawImage(renderer, 0, 0, width, height, 0, 0, my.width, my.height // destination width, height
          );
        });
      }
    }
